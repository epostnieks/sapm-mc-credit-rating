#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Credit Rating Agencies / Issuer-Pays Corruption Floor
=====================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Credit Rating Agencies (Issuer-Pays Corruption Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "credit_rating",
    "domain_name": "Credit Rating Agencies",
    "theorem": "Issuer-Pays Corruption Floor",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 11.0,
    "channels": {
        "C1_rating_inflation": {
            "dist": "lognormal",
            "low": 24,
            ...
            "high": 42,
            "weight": 0.25,
            "description": "Capital misallocation from inflated ratings"
        },
        "C2_procyclical": {
            "dist": "lognormal",
            "low": 18,
            ...
            "high": 30,
            "weight": 0.2,
            "description": "Cliff effects, forced selling, rating-triggered cascades"
        },
        "C3_sovereign": {
            "dist": "lognormal",
            "low": 12,
            ...
            "high": 16,
            "weight": 0.15,
            "description": "Developing nation borrowing cost penalties"
        },
        "C4_competition": {
            "dist": "lognormal",
            "low": 4.5,
            ...
            "high": 8.0,
            "weight": 0.1,
            "description": "NRSRO oligopoly, competition suppression"
        },
        "C5_systemic": {
            "dist": "lognormal",
            "low": 28,
            ...
            "high": 45,
            "weight": 0.2,
            "description": "Systemic fragility, institutional lock-in"
        },
        "C6_democratic": {
            "dist": "lognormal",
            "low": 6,
            ...
            "high": 12,
            "weight": 0.1,
            "description": "Democratic accountability deficit, austerity imposition"
        }
    },
